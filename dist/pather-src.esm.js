import { Polyline, DivIcon, Marker, LineUtil, Point, FeatureGroup } from 'leaflet';
...
var PatherPolyline = /** @class */ (function () {
    ...
    PatherPolyline.prototype.attachElbows = function () {
        ...
        this.getLatLngs().forEach(function (latLng) {
            var icon = new DivIcon({ className: 'elbow' });
            var edge = new Marker(latLng, { icon: icon }).addTo(_this.map);
    ...
    PatherPolyline.prototype.insertElbow = function (latLng) {
        ...
        points.forEach(function (currentPoint, index) {
            ...
            var distance = LineUtil.pointToSegmentDistance(newPoint, currentPoint, nextPoint);
